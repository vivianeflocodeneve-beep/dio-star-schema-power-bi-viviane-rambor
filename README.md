...
![Modelo real no Power BI](images/modelo-star-schema-real.jpg)
...
| Papel no modelo | Tabela no Power BI | Finalidade |
|---|---|---|
| Fato | `tblFVendas` | Registros e métricas das vendas |
| Dimensão | `tblDCalendario` | Análises por data e período |
| Dimensão | `tblDProdutos` | Informações consolidadas dos produtos |
| Dimensão | `tblDProdutosDetalhes` | Detalhes complementares dos produtos |
| Dimensão | `tblDDescontos` | Faixas e informações de desconto |
| Dimensão | `tblDDetalhes` | Segmento e país |
...
Os códigos estão disponíveis em [`docs/dax-medidas.md`](docs/dax-medidas.md).
...
[`powerbi/StarSchema_Vendas_Viviane_Rambor.pbix`](powerbi/StarSchema_Vendas_Viviane_Rambor.pbix)
